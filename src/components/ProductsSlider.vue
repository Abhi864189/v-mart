...
const breakpoints = {
  576: { itemsToShow: 1, snapAlign: 'start' },
  768: {
    itemsToShow: 2,
    snapAlign: 'start'
  },
...
<template>
  <div class="home-product-slider-container">
    ...
    <Carousel
      ...
      :transition="500"
    >
      <Slide v-for="item in data" :key="item._id">
...
<style scoped>
.home-product-slider-container .container_title {
  display: flex;
  align-items: center;
